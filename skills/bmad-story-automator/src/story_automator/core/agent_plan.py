...
from .agent_config import parse_agent_config_json, resolve_agent_for_task, normalize_fallback_value
...
def resolve_agents_payload(payload: dict[str, Any], story_id: str, task: str) -> dict[str, Any]:
    for story in payload.get("stories", []):
        ...
        return {"ok": True, "story": story_id, "task": task, "primary": selection.get("primary"), "fallback": fallback, "complexity": story.get("complexity")}
